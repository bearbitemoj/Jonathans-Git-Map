...
numSamplesPerLabelPerBin = 3; % Number of samples per label per bin, set to inf for max number (total number is numLabels*numSamplesPerBin)
...
W0 = ((b-a)*rand(numHidden+1,numOfFeatures+1) + a)/sqrt(numOfFeatures); % Change this, Initiate your weight matrix W (hidden neurons)
V0 = ((b-a)*rand(numOfClasses,numHidden+1) + a)/sqrt(numHidden); % Change this, Initiate your weight matrix V (output neurons)
